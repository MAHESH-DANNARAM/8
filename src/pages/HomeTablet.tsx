...
import RemoteTeamsContainer from "../components/RemoteTeamsContainer";
import InfoSectionContainer1 from "../components/InfoSectionContainer1";
import ReviewCarouselWrapper from "../components/ReviewCarouselWrapper";

const HomeTablet: FunctionComponent = () => {
  return (
    <div className="relative bg-off-white w-full h-[334.75rem] overflow-hidden text-left text-[3.13rem] text-dark-blue font-paragraph-mobile">
      <RemoteTeamsContainer />
      <div className="absolute top-[52.5rem] left-[calc(50%_-_372px)] bg-off-white w-[46.5rem] h-[71.25rem] overflow-hidden text-[0.33rem] font-plus-jakarta-sans">
        <div className="absolute top-[3.75rem] left-[3.75rem] flex flex-col items-start justify-center gap-[3.5rem]">
            ...
            <div className="absolute top-[1.06rem] left-[1.46rem] rounded-[3.72px] bg-primary-0 shadow-[0px_13px_26px_rgba(118,_118,_178,_0.24)] w-[8.66rem] h-[17.88rem] overflow-hidden text-secondary-500">
              ...
              <div className="absolute top-[8.57rem] left-[0.56rem] flex flex-row items-start justify-start gap-[0.19rem] text-[0.37rem]">
                <img
                  ...
                  alt=""
                  src="/iconlylighttime-circle4.svg"
                />
                  ...
                  <div className="rounded-[6.39px] flex flex-col py-[0.4rem] px-[0.8rem] items-start justify-start">
                    <div className="flex flex-row items-start justify-start gap-[0.48rem]">
                      <img
                        className="relative w-[0.96rem] h-[0.96rem]"
                        alt=""
                        src="/vuesaxlinearuseroctagon1.svg"
                      />
                      <div className="relative tracking-[-0.02em] leading-[150%] font-semibold flex items-center w-[4.47rem] h-[0.96rem] shrink-0">
                        Mentors
                      </div>
                  ...
                  <div className="relative rounded-[6.39px] bg-primary-0 w-[13.09rem] h-[12.53rem] overflow-hidden shrink-0">
                    ...
                    <div className="absolute top-[10.62rem] left-[0.96rem] flex flex-row items-start justify-start gap-[0.32rem]">
                      <img
                        className="relative w-[0.96rem] h-[0.96rem]"
                        alt=""
                        src="/iconlylighttime-circle5.svg"
                      />
                  ...
                  <div className="relative rounded-[6.39px] bg-primary-0 w-[13.09rem] h-[12.53rem] overflow-hidden shrink-0">
                    ...
                    <div className="absolute top-[10.62rem] left-[0.96rem] flex flex-row items-start justify-start gap-[0.32rem]">
                      <img
                        className="relative w-[0.96rem] h-[0.96rem]"
                        alt=""
                        src="/iconlylighttime-circle6.svg"
                      />
                      <div className="relative tracking-[-0.02em] leading-[150%] font-medium flex items-center w-[3.67rem] h-[0.96rem] shrink-0">
                        4 Days Left
                      </div>
          ...
          <div className="w-[39rem] flex flex-col items-start justify-start gap-[3rem] text-[3.13rem] font-paragraph-mobile">
      ...
      <b className="absolute top-[233.19rem] left-[calc(50%_-_231px)] leading-[4rem] inline-block text-center w-[28.88rem]">
        What people say about Team
      </b>
      <InfoSectionContainer1
        chatText="/imggroup6.svg"
        ...
        chatImageText="/iconactionarrow-right-alt-24px.svg"
      />
      <div className="absolute top-[167.06rem] left-[calc(50%_-_372px)] w-[46.5rem] flex flex-row items-start justify-start gap-[1.5rem]">
        <div className="w-[23rem] flex flex-col py-[0rem] pr-[0rem] pl-[1.5rem] box-border items-start justify-start gap-[3rem]">
          <div className="self-stretch flex flex-col items-start justify-start gap-[1.5rem]">
            <b className="self-stretch relative leading-[4rem]">
      ...
      <InfoSectionContainer1
        ...
        chatImageText="/iconactionarrow-right-alt-24px1.svg"
        propTop="198.88rem"
      />
      <div className="absolute bottom-[0rem] left-[calc(50%_-_372px)] w-[46.5rem] h-[48.75rem] overflow-hidden text-[1.5rem] text-off-white">
        ...
        <div className="absolute top-[28.5rem] left-[2.5rem] w-[16.75rem] h-[7.81rem] text-[0.88rem]">
          ...
          <div className="absolute top-[4.94rem] left-[0rem] rounded bg-whitesmoke-200 w-[16.75rem] overflow-hidden flex flex-row py-[0.69rem] px-[1rem] box-border items-start justify-between">
            ...
            <img
              className="relative w-[1.5rem] h-[1.5rem]"
              alt=""
              src="/iconnavigationarrow-forward-24px3.svg"
            />
          </div>
        </div>
      </div>
      <ReviewCarouselWrapper
        productIds="/star5.svg"
        productImageIds="/star6.svg"
        productImageDimensions="/star7.svg"
        productImageIds32x32="/star8.svg"
        productImageIds32x32x="/star9.svg"
        productImageIds56x56x="/avatar158.svg"
        productImageIds32x32x2031="/star.svg"
        productImageIds32x32x4157="/star1.svg"
        productImageIds32x32x2297="/star2.svg"
        productImageIds32x32x3410="/star3.svg"
        productImageIds32x32x3627="/star4.svg"
        productImageIds56x56x2="/avatar159.svg"
        productImageIds32x32x8048="/star.svg"
        productImageIds32x32x3310="/star1.svg"
        productImageIds32x32x22972="/star2.svg"
        productImageIds32x32x34102="/star3.svg"
        productImageIds32x32x36272="/star4.svg"
        productImageIds56x56x3="/avatar160.svg"
        productImageIds32x32x80482="/star.svg"
        productImageIds32x32x33102="/star1.svg"
        productImageIds32x32x22973="/star2.svg"
        productImageIds32x32x34103="/star3.svg"
        productImageIds32x32x36273="/star4.svg"
        productImageIds56x56x4="/avatar161.svg"
        productImageIds32x32x20312="/star.svg"
        productImageIds32x32x2="/star1.svg"
        productImageIds32x32x22974="/star2.svg"
        productImageIds32x32x34104="/star3.svg"
        productImageIds32x32x36274="/star4.svg"
        productImageIds56x56x5="/avatar162.svg"
      />
      <img
        className="absolute top-[132.25rem] right-[25.31rem] w-[10rem] h-[4.29rem] object-cover"
        alt=""
        src="/calender2@2x.png"
      />
      <img
        className="absolute top-[168.06rem] left-[36.75rem] w-[8.75rem] h-[3.75rem] object-cover"
        alt=""
        src="/image152@2x.png"
      />
      <img
        className="absolute top-[172.57rem] left-[36.75rem] w-[8.75rem] h-[8.36rem] object-cover"
        alt=""
        src="/image153@2x.png"
      />
      <img
        className="absolute top-[211.88rem] left-[1rem] w-[8.75rem] h-[8.36rem] object-cover"
        alt=""
        src="/image154@2x.png"
      />
      <img
        className="absolute top-[221rem] left-[1rem] w-[8.75rem] h-[3.75rem] object-cover"
        alt=""
        src="/image155@2x.png"
      />
    </div>
