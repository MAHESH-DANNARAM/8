...
const HomeMobilePortrait: FunctionComponent = () => {
  return (
    <div className="relative bg-off-white w-full h-[397.06rem] overflow-hidden text-left text-[2.13rem] text-dark-blue font-paragraph-mobile">
      <div className="absolute top-[0rem] left-[0rem] bg-primary-0 w-[20rem] h-[48.75rem] overflow-hidden text-off-white">
        <img
          className="absolute top-[0rem] left-[0rem] w-[20rem] h-[50rem] object-cover"
          alt=""
          src="/heroimg@2x.png"
        />
        <div className="absolute top-[calc(50%_-_120px)] left-[calc(50%_-_130px)] flex flex-col items-start justify-start gap-[3.5rem]">
          <div className="w-[16.25rem] flex flex-col items-start justify-start gap-[1rem]">
            <b className="self-stretch relative leading-[2.63rem]">
              Instant collaboration for remote teams
            </b>
            <div className="self-stretch relative text-[1rem] leading-[1.5rem]">
              All-in-one place for your remote team to chat, collaborate and
              track project progress.
            </div>
          </div>
          <div className="self-stretch flex flex-col items-start justify-start gap-[1rem] text-[0.88rem] text-desaturated-blue">
            <div className="self-stretch rounded bg-off-white box-border h-[2.94rem] overflow-hidden shrink-0 flex flex-row py-[0.69rem] px-[1rem] items-center justify-between border-[2px] border-solid border-grayish-blue">
            ...
            <div className="self-stretch rounded bg-soft-blue overflow-hidden flex flex-row py-[0.63rem] px-[2.75rem] items-center justify-center text-center text-[1.13rem] text-off-white">
              <div className="relative leading-[150%]">Button Label</div>
            </div>
          </div>
        </div>
        <div className="absolute top-[1.88rem] left-[calc(50%_-_130px)] w-[16.25rem] flex flex-row items-center justify-between text-[3.13rem]">
      ...
      <div className="absolute top-[51.25rem] left-[calc(50%_-_160px)] bg-off-white w-[20rem] h-[75rem] overflow-hidden text-[0.33rem] font-plus-jakarta-sans">
        <div className="absolute top-[3.75rem] left-[1.88rem] flex flex-col items-start justify-center gap-[3rem]">
          <div className="relative w-[64.61rem] h-[40.88rem]">
            <div className="absolute top-[1.06rem] left-[1.46rem] rounded-[3.72px] bg-primary-0 shadow-[0px_13px_26px_rgba(118,_118,_178,_0.24)] w-[7.5rem] h-[15.48rem] overflow-hidden text-secondary-500">
            ...
            <div className="absolute top-[0rem] left-[7.13rem] rounded-xl bg-gray-100 shadow-[0px_8px_24px_rgba(118,_118,_178,_0.24)] w-[57.48rem] h-[40.88rem] overflow-hidden text-[0.96rem]">
              ...
              <div className="absolute top-[5.91rem] left-[11.34rem] rounded-[6.39px] bg-dark-blue w-[7.74rem] h-[8.54rem] text-[1.28rem] text-off-white">
                ...
                <div className="absolute top-[4.95rem] left-[0.8rem] w-[2.71rem] h-[2.71rem] text-center text-[0.72rem]">
                  <div className="absolute top-[0rem] left-[0rem] w-[2.71rem] h-[2.71rem]">
                    <img
                      className="absolute top-[0rem] left-[0rem] w-[2.71rem] h-[2.71rem]"
                      alt=""
                      src="/chart.svg"
                    />
              ...
              <div className="absolute top-[5.91rem] left-[20.36rem] rounded-[6.39px] bg-whitesmoke-100 w-[18.44rem] h-[8.54rem] overflow-hidden text-center text-[0.48rem]">
                ...
                <div className="absolute top-[2.56rem] left-[0.8rem] rounded-[6.39px] bg-primary-0 w-[16.85rem] h-[5.19rem] overflow-hidden">
                  ...
                  <img
                    className="absolute top-[0.96rem] left-[1.76rem] w-[14.29rem] h-[2.91rem]"
                    alt=""
                    src="/cart.svg"
                  />
                </div>
                <div className="absolute top-[4.79rem] left-[4.63rem] flex flex-col items-center justify-center">
                  <img
                    className="relative w-[0.64rem] h-[0.64rem]"
                    alt=""
                    src="/point.svg"
                  />
                </div>
                <div className="absolute top-[2.44rem] left-[3.27rem] w-[3.35rem] h-[1.88rem] text-[0.56rem] text-primary-0">
                  <img
                    className="absolute top-[1.88rem] left-[1.28rem] rounded-[1.28px] w-[0.8rem] h-[0.56rem]"
                    alt=""
                    src="/polygon-2.svg"
                  />
            ...
            <div className="absolute top-[18.38rem] left-[12.63rem] rounded-3xs bg-soft-blue shadow-[0px_8px_24px_rgba(118,_118,_178,_0.24)] flex flex-row p-[0.63rem] items-start justify-start">
              <img
                className="relative w-[1.5rem] h-[1.5rem]"
                alt=""
                src="/send2.svg"
          ...
          <div className="w-[16.25rem] flex flex-col items-start justify-start gap-[3rem] text-[2.13rem] font-paragraph-mobile">
      ...
      <b className="absolute top-[269.19rem] left-[calc(50%_-_120px)] leading-[2.63rem] inline-block text-center w-[15rem]">
        What people say about Team
      </b>
      <ChatContainer
        chatText="/imggroup.svg"
        ...
        chatThreadText="/iconactionarrow-right-alt-24px.svg"
      />
      <ChatContainer
        chatText="/imggroup1.svg"
        teamChatText="Choose how you want to work"
        teamThreadText="In Team, you’ve got all the flexibility to work when, where and how it’s best for you. You can easily chat, send audio and video clips, or hop on a huddle to talk things out live."
        chatThreadText="/iconactionarrow-right-alt-24px.svg"
        propTop="176rem"
      />
      <ChatContainer
        chatText="/imggroup2.svg"
        ...
        chatThreadText="/iconactionarrow-right-alt-24px1.svg"
        propTop="221.56rem"
      />
      <CompanyContainer productId="/iconnavigationarrow-forward-24px3.svg" />
      <ReviewCarouselContainer
        productIds="/avatar148.svg"
        productIdsArray="/avatar149.svg"
        selectedProductIds="/avatar150.svg"
        productIdsToCompare="/avatar151.svg"
        productIdsToCompare2="/avatar152.svg"
      />
      <img
        className="absolute top-[129.5rem] right-[1.81rem] w-[10.5rem] h-[4.5rem] object-cover"
        alt=""
        src="/calender@2x.png"
      />
      <img
        className="absolute top-[176.75rem] left-[11.5rem] w-[6.5rem] h-[2.79rem] object-cover"
        alt=""
        src="/image144@2x.png"
      />
      <img
        className="absolute top-[180.06rem] left-[11.5rem] w-[6.5rem] h-[6.21rem] object-cover"
        alt=""
        src="/image145@2x.png"
      />
      <img
        className="absolute top-[229.31rem] left-[0.75rem] w-[6.5rem] h-[6.21rem] object-cover"
        alt=""
        src="/image146@2x.png"
      />
      <img
        className="absolute top-[236rem] left-[0.75rem] w-[6.5rem] h-[2.79rem] object-cover"
        alt=""
        src="/image147@2x.png"
      />
    </div>
...
export default HomeMobilePortrait;
